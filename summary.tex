...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item In gases viscious forces small $\rightarrow$ sometimes neglected
	...
	\begin{itemize}
		...
		\item[$\rightarrow$] high $\rightarrow$ turbolence; low $\rightarrow$ laminar
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Presure: $p : \Omega \times [0, t_{end}] \rightarrow \mathds{R}$
...
\begin{itemize}
	...
	\item $\vec{u} \text{ grad} := ( \begin{pmatrix}
		u \\
		v
	\end{pmatrix}
	\cdot \begin{pmatrix}
	...
	\item $(\vec{u} \text{ grad} ) \vec{u} = (u \cdot \frac{\delta}{\delta x} + v \frac{\delta}{\delta y}\begin{pmatrix}
		u \\
		v
...
\begin{figure}
	\centering
	\[ \frac{\delta u}{\delta t} + \frac{\delta p}{\delta x} = \frac{1}{Re} ( \frac{\delta^2 u}{\delta x^2} + \frac{\delta^2 u}{\delta y^2}) - \frac{\delta (u^2)}{\delta x} - \frac{\delta (uv)}{\delta y} + g_x\]
...
\begin{figure}
	\centering
	\[ \frac{\delta v}{\delta t} + \frac{\delta p}{\delta y} = \frac{1}{Re} ( \frac{\delta^2 v}{\delta x^2} + \frac{\delta^2 v}{\delta y^2}) - \frac{\delta (uv)}{\delta x} - \frac{\delta (v^2)}{\delta y} + g_x\]
